...
students["234-56-9010"] #Seaching a value by its key
...
students2 == students3
students2 != students3
tuple(students.keys()) #Return a sequence of keys
tuple(students.values()) #Return a sequence of values
tuple(students.items()) #Return a sequence of tuples. Each tuple is (key:value) for an item
students.get("111-34-3434") #Returns the value for the keys
students.pop("111-34-3434") #Removes the item for the key and return its value
